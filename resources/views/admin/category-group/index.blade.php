<x-app-layout>
    ...
    @endpush
    @section('title')Category Group @endsection
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <div class="float-right">
                            <a href="{{ route('category-group.create') }}" class="btn btn-sm btn-block btn-success"><i class="fas fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <a href="{{ route('category-group.edit', [$p->id]) }}" class="btn btn-warning btn-sm text-white btn-block">
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content rounded-0">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form action="{{route('category-group.destroy', [$p->id])}}" method="POST" class="d-inline">
                                                                            @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <a href="{{ route('category-group.edit', [$d->id]) }}" class="btn btn-warning btn-sm text-white btn-block">
                                                                    <i class="fas fa-edit"></i> Edit
                                                                </a>
                                                            </div>
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="modal fade" id="deleteModal{{ $d->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $d->id }}" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content rounded-0">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form action="{{route('category-group.destroy', [$d->id])}}" method="POST" class="d-inline">
                                                                            @csrf
                                                                            <input type="hidden" value="DELETE" name="_method">
                                                                            <button type="submit" class="btn btn-danger"><i class="fas fa-trash mr-1"></i> Delete</button>
                                                                        </form>
